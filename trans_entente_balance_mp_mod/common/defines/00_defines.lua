...
NDiplomacy = {
	...
	DIPLOMACY_HOURS_BETWEEN_REQUESTS = 0,			-- How long a country must wait before sending a new diplomatic request.
...
NCountry = {
	...
	STARTING_COMMAND_POWER = 25.0,					-- starting command power for every country
...
NProduction = {
	...
	BASE_FACTORY_EFFICIENCY_VARIANT_CHANGE_FACTOR = 97,		-- Base factor for changing production variants in %.
...
NMilitary = {
	...
	NUKE_MIN_DAMAGE_PERCENT = 0.05,					-- Minimum damage from nukes as a percentage of current strength/organisation
	NUKE_MAX_DAMAGE_PERCENT = 0.25,					-- Minimum damage from nukes as a percentage of current strength/organisation
...
NAir = {
	...
	COMBAT_MAX_WINGS_AT_ONCE_PORT_STRIKE = 5000,        -- we can really pounce a naval strike and escalate
	...
	ACE_WING_SIZE =	75,								-- size of wing ace bonuses are set up for. if lower more bonus, if higher less bonus
	...
	ANTI_AIR_PLANE_DAMAGE_FACTOR = 0.7,					-- Anti Air Gun Damage factor
	ANTI_AIR_PLANE_DAMAGE_CHANCE = 0.07,					-- Anti Air Gun hit chance
	...
	MANPOWER_LOSS_RATIO_PLANE_SHOT = 0.01,	-- The loss ratio of manpower for a shot plane.
	...
	MISSION_FUEL_COSTS = {  -- fuel cost per plane for each mission
		...
		1.5, -- AIR_SUPPLY
		0.3, -- TRAINING
		1.25, -- NAVAL_MINES_PLANTING
		1.5, -- NAVAL_MINES_SWEEPING
		1.25, -- RECON
		1.25, -- NAVAL_PATROL
	},
