...
NProduction = {
	...
	BASE_FACTORY_SPEED_NAV = 4, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
	...
	BASE_FACTORY_EFFICIENCY_VARIANT_CHANGE_FACTOR = 100,		-- Base factor for changing production variants in %.
...
NMilitary = {
	...
	ENEMY_AIR_SUPERIORITY_IMPACT = -0.1,          -- effect on defense due to enemy air superiorty
...
NAir = {
	...
	THRUST_WEIGHT_SPEED_FACTOR = 3,								-- For plane designs, additive agility bonus per point of thrust exceeding weight
